### **توثيق مشروع IslamicQuizAPI**

**IslamicQuizAPI** هو مشروع مفتوح المصدر يوفر **قاعدة بيانات متعددة التنسيقات** تشمل **JSON، SQLite، وCSV**، إضافةً إلى **واجهة برمجة تطبيقات (API)** مخصصة لتسهيل استخدام الأسئلة الشرعية في التطبيقات والمشاريع المختلفة.
...
[dorar.net](https://dorar.net/m3lama) | جميع البينات ماخوذه من موقع معلمة الدرر
